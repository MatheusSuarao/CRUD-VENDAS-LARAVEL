        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form action="{{ route('cliente.cadastrar') }}" method="POST">
                    ...
                    <div class="form-floating mb-3">
                        <input type="email" class="form-control" name="email" id="email" placeholder="E-mail@email.com" required>
                        <label for="email">Email:</label>
                    </div>

                    <button class="btn btn-md btn-success" type="submit">Cadastrar Cliente</button>
                </form>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <div class="d-flex gap-4">
                            ...
                            <a href="{{ route('cliente.excluir', $item->id_cliente) }}">
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        document.querySelectorAll('.edit-product').forEach(button => {
            button.addEventListener('click', function() {
                ...
                const clientNome = this.getAttribute('data-name');
                const clientEmail = this.getAttribute('data-email');

                // Preencha o formulário na modal com os dados
                document.getElementById('clientNome').value = clientNome;
                document.getElementById('clientEmail').value = clientEmail;

                // Defina a rota correta para o formulário de edição
                const formAction = `/cliente/atualizar/${clientId}`;
                document.getElementById('clientEdit').action = formAction;

                // Abre a modal
                const modal = new bootstrap.Modal(document.getElementById('modaleditcliet'));
                modal.show();
            });
        });
    });
